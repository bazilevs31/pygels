...
graph TD;
    ...
    L --> L1(Profile info from dump files);
    L --> L2(Electrostatic Potential from .dcd trajectory file);
    L --> L3 (analyze the boundary of the system and condensation with condensation.py);
